...
@Repository("fileCkEditorDaoAnnounceImpl")
public class FileCkEditorDaoAnnounceImpl implements FileCkEditorDao {
    @Autowired
    private SqlSession sqlSession;
    private static final String namespace = "com.nki.t1.dao.FileAnnounceCkMapper.";
    ...
    public int deleteFileByPostIdx(int idx) {
        return sqlSession.delete(namespace + "deleteFileByPostIdx", idx);
    }
